...
"urGUIConfig.lua",
"urFinalBowls.lua",
"urFinalColor_latest.lua",
"urFinalDancer-modulation.lua",
"urFinalDudukVers6NOVIB.lua",
"urFinalHarmonizer.lua",
"urFinalHarmonyChaos.lua",
"urFinalSoundDropslave.lua",
"urFinalStory_latest.lua",
"urFinalTtss.lua",
--"urDistress.lua",
--"urRainstick.lua",
--"urSwarm.lua",
